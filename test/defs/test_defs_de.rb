...
[:de_bw, :de_by, :de_by_aux, :de_he, :de_nw, :de_rp, :de_sl, :de_].each do |r|
...
[:de_bw, :de_by, :de_by_aux, :de_nw, :de_rp, :de_sl, :de_].each do |r|
...
# Carnival
[:de_bw, :de_by, :de_by_aux, :de_he, :de_nw, :de_rp, :de_sl, :de_sn].each do |r|
