    ...
    def self.holidays_by_month
      {
            ...
            {:function => lambda { |year| Holidays.easter(year)-46 }, :function_id => "easter(year)-46", :length => 43, :name => "Lent", :regions => [:graceway]},
            ...
            {:function => lambda { |year| Holidays.advent_sunday(year) }, :function_id => "advent_sunday(year)", :date_end => "12/24", :name => "Advent", :regions => [:graceway]}],
      ...
      5 => [{:wday => 4, :week => 1, :name => "National Day of Prayer", :regions => [:graceway]},
            {:wday => 0, :week => 2, :name => "Mother's Day", :regions => [:graceway]},
      ...
      6 => [{:wday => 0, :week => 1, :hide_date => true, :name => "Summer Events", :regions => [:graceway]},
            {:wday => 0, :week => 3, :name => "Father's Day", :regions => [:graceway]}],
      ...
      11 => [{:wday => 0, :week => 1, :name => "Daylight Savings Ends", :regions => [:graceway]},
            ...
            {:mday => 11, :name => "Veteran's Day", :regions => [:graceway]},
