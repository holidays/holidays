    ...
    def self.holidays_by_month
      {
            ...
            {:function => lambda { |year| Holidays.easter(year)-1 }, :function_id => "easter(year)-1", :name => "Påskeaften", :type => :informal, :regions => [:no]},
            ...
            {:function => lambda { |year| Holidays.easter(year)+48 }, :function_id => "easter(year)+48", :type => :informal, :name => "Pinseaften", :regions => [:no]},
