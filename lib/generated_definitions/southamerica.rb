    ...
    def self.holidays_by_month
      {
            ...
            {:function => "easter(year)", :function_arguments => [:year], :type => :informal, :name => "Pascua", :regions => [:pe]},
      ...
      1 => [{:mday => 1, :name => "Año Nuevo", :regions => [:ar]},
            ...
            {:mday => 6, :type => :informal, :name => "Día de los Reyes Magos", :regions => [:pe]},
            {:mday => 1, :name => "Año Nuevo", :regions => [:ve]}],
      3 => [{:mday => 24, :name => "Día Nacional de la Memoria por la Verdad y la Justicia", :regions => [:ar]},
            {:mday => 19, :function => "to_following_monday_if_not_monday(date)", :function_arguments => [:date], :name => "Día de San José", :regions => [:co]}],
      ...
      6 => [{:mday => 17, :function => "to_nearest_monday(date)", :function_arguments => [:date], :name => "Paso a la Inmortalidad del General Martín Miguel de Güemes", :regions => [:ar]},
            ...
            {:mday => 29, :function => "to_following_monday_if_not_monday(date)", :function_arguments => [:date], :name => "San Pedro y San Pablo", :regions => [:co]},
            {:mday => 7, :year_ranges => { :until => 2023 },:type => :informal, :name => "Día de la Bandera", :regions => [:pe]},
            {:mday => 7, :year_ranges => { :from => 2024 },:name => "Batalla de Arica y Día de la Bandera", :regions => [:pe]},
            {:wday => 0, :week => 3, :type => :informal, :name => "Día del Padre", :regions => [:pe]},
            {:mday => 24, :type => :informal, :name => "Inti Raymi", :regions => [:pe]},
            {:mday => 29, :name => "Día de San Pedro y San Pablo", :regions => [:pe]},
      ...
      7 => [{:mday => 8, :year_ranges => { :limited => [2016] },:name => "Feriado con fines turísticos", :regions => [:ar]},
            ...
            {:mday => 9, :function => "to_following_monday_if_not_monday(date)", :function_arguments => [:date], :year_ranges => { :from => 2026 },:name => "Día de Nuestra Señora del Rosario de Chiquinquirá", :regions => [:co]},
            {:mday => 20, :name => "Día de la Independencia", :regions => [:co]},
            {:mday => 23, :year_ranges => { :from => 2023 },:name => "Día de la Fuerza Aérea del Perú", :regions => [:pe]},
      ...
      8 => [{:mday => 17, :function => "to_nearest_monday(date)", :function_arguments => [:date], :name => "Paso a la Inmortalidad del General José de San Martín", :regions => [:ar]},
            ...
            {:mday => 6, :year_ranges => { :from => 2022 },:name => "Batalla de Junín", :regions => [:pe]},
      ...
      10 => [{:mday => 12, :function => "to_nearest_monday(date)", :function_arguments => [:date], :name => "Día del Respeto a la Diversidad Cultural", :regions => [:ar]},
            ...
            {:mday => 12, :function => "to_following_monday_if_not_monday(date)", :function_arguments => [:date], :name => "Día de la Raza", :regions => [:co]},
            {:mday => 8, :name => "Combate de Angamos", :regions => [:pe]},
      ...
      11 => [{:mday => 20, :name => "Día de la Soberanía Nacional", :regions => [:ar]},
            ...
            {:mday => 1, :function => "to_following_monday_if_not_monday(date)", :function_arguments => [:date], :name => "Día de Todos los Santos", :regions => [:co]},
      ...
      12 => [{:mday => 8, :name => "Inmaculada Concepción de María", :regions => [:ar]},
            ...
            {:mday => 9, :year_ranges => { :from => 2022 },:name => "Batalla de Ayacucho", :regions => [:pe]},
