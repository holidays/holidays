  ...
  module EUROPE # :nodoc:
    ...
    def self.holidays_by_month
      ...
      12 => [{:mday => 8, :name => "Mariä Empfängnis", :regions => [:at]},
            ...
            {:mday => 25,  :year_ranges => [{:before => 2021},{:after => 2023}],:observed => "to_monday_if_weekend(date)", :observed_arguments => [:date], :name => "Christmas Day", :regions => [:gb]},
      ...
      2 => [{:mday => 28, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Día de Andalucía", :regions => [:es_an]},
            {:wday => 1, :week => 1, :name => "St Brigid's Day", :regions => [:ie]},
