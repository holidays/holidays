  ...
  module EUROPE # :nodoc:
    ...
    def self.holidays_by_month
      ...
      1 => [{:mday => 1, :name => "Neujahrstag", :regions => [:at]},
            ...
            {:mday => 6, :year_ranges => { :from => 2024 },:name => "Botezul Domnului - Boboteaza", :regions => [:ro]},
            {:mday => 7, :year_ranges => { :from => 2024 },:name => "Soborul Sfântului Proroc Ioan Botezătorul", :regions => [:ro]},
      ...
      5 => [{:mday => 1, :name => "Staatsfeiertag", :regions => [:at]},
            ...
            {:mday => 1, :year_ranges => { :from => 1933 },:name => "Tag der Arbeit", :regions => [:de]},
