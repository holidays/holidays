    ...
    def self.holidays_by_month
      {
            ...
            {:function => "orthodox_easter(year)", :function_arguments => [:year], :function_modifier => -2,  :year_ranges => [{:after => 2018}],:name => "Paștele - Vinerea Mare", :regions => [:ro]},
      ...
      1 => [{:mday => 1, :name => "Neujahrstag", :regions => [:at]},
            ...
            {:mday => 24,  :year_ranges => [{:after => 2017}],:name => "Unirea Principatelor Române", :regions => [:ro]},
      ...
      8 => [{:mday => 15, :name => "Mariä Himmelfahrt", :regions => [:at]},
            ...
            {:mday => 24,  :year_ranges => [{:after => 1992}],:observed => "to_monday_if_weekend(date)", :observed_arguments => [:date], :name => "День Незалежності", :regions => [:ua]}],
      10 => [{:mday => 26, :name => "Nationalfeiertag", :regions => [:at]},
            ...
            {:mday => 14,  :year_ranges => [{:after => 2015}],:observed => "to_monday_if_weekend(date)", :observed_arguments => [:date], :name => "День захисника України", :regions => [:ua]}],
      ...
      12 => [{:mday => 8, :name => "Mariä Empfängnis", :regions => [:at]},
            ...
            {:mday => 25,  :year_ranges => [{:after => 2017}],:observed => "to_monday_if_weekend(date)", :observed_arguments => [:date], :name => "Різдво Христове", :regions => [:ua]}],
      ...
      3 => [{:mday => 1, :name => "Instauration de la République", :regions => [:ch_ne]},
            ...
            {:mday => 8,  :year_ranges => [{:after => 2019}],:name => "Internationaler Frauentag", :regions => [:de_be]},
      ...
      6 => [{:mday => 23, :name => "Commémoration du plébiscite jurassien", :regions => [:ch_ju]},
            ...
            {:mday => 1,  :year_ranges => [{:after => 2017}],:name => "Ziua Copilului", :regions => [:ro]},
            {:mday => 25, :name => "dan državnosti", :regions => [:si]},
            {:mday => 28,  :year_ranges => [{:after => 1997}],:observed => "to_monday_if_weekend(date)", :observed_arguments => [:date], :name => "День Конституції", :regions => [:ua]}],
