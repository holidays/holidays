    ...
    def self.holidays_by_month
      {
            ...
            {:mday => 1, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]}],
      2 => [{:mday => 11, :name => "建国記念日", :regions => [:jp]},
            {:mday => 11, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]}],
      3 => [{:function => "jp_vernal_equinox_day(year)", :name => "春分の日", :regions => [:jp]},
            {:function => "jp_vernal_equinox_day_substitute(year)", :name => "振替休日", :regions => [:jp]}],
      4 => [{:mday => 29, :name => "昭和の日", :regions => [:jp]},
            {:mday => 29, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]}],
      5 => [{:mday => 3, :name => "憲法記念日", :regions => [:jp]},
            {:mday => 4, :name => "みどりの日", :regions => [:jp]},
            {:mday => 5, :name => "こどもの日", :regions => [:jp]},
            {:mday => 3, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]},
            {:mday => 4, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]},
            {:mday => 5, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]}],
      7 => [{:mday => 20,  :year_ranges => [{:between => 1996..2002}],:name => "海の日", :regions => [:jp]},
            {:wday => 1, :week => 3,  :year_ranges => [{:after => 2003}],:name => "海の日", :regions => [:jp]},
            {:function => "jp_marine_day_substitute(year)",  :year_ranges => [{:between => 1996..2002}],:name => "振替休日", :regions => [:jp]}],
      8 => [{:function => "jp_mountain_holiday(year)",  :year_ranges => [{:after => 2016}],:name => "山の日", :regions => [:jp]},
            {:function => "jp_mountain_holiday_substitute(year)",  :year_ranges => [{:after => 2016}],:name => "振替休日", :regions => [:jp]}],
      9 => [{:wday => 1, :week => 3, :name => "敬老の日", :regions => [:jp]},
            {:function => "jp_respect_for_aged_holiday_substitute(year)", :name => "振替休日", :regions => [:jp]},
            {:function => "jp_citizens_holiday(year)", :name => "国民の休日", :regions => [:jp]},
            {:function => "jp_national_culture_day(year)", :name => "秋分の日", :regions => [:jp]},
            {:function => "jp_national_culture_day_substitute(year)", :name => "振替休日", :regions => [:jp]}],
      10 => [{:wday => 1, :week => 2, :name => "体育の日", :regions => [:jp]},
            {:function => "jp_health_sports_day_substitute(year)", :name => "振替休日", :regions => [:jp]}],
      11 => [{:mday => 3, :name => "文化の日", :regions => [:jp]},
            {:mday => 3, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]},
            {:mday => 23, :name => "勤労感謝の日", :regions => [:jp]},
            {:mday => 23, :function => "jp_substitute_holiday(year, month, day)", :name => "振替休日", :regions => [:jp]}],
