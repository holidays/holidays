  ...
  module JP # :nodoc:
    ...
    def self.holidays_by_month
      ...
      7 => [{:wday => 1, :week => 3, :name => "海の日", :regions => [:jp]},
            {:function => lambda { |year| Holidays.jp_substitute_holiday(year, 7, Holidays::DateCalculator.day_of_month(year, 7, 3, 1)) }, :function_id => "jp_substitute_holiday(year, 7, Holidays::DateCalculator.day_of_month(year, 7, 3, 1))", :name => "振替休日", :regions => [:jp]}],
      9 => [{:wday => 1, :week => 3, :name => "敬老の日", :regions => [:jp]},
            {:function => lambda { |year| Holidays.jp_substitute_holiday(year, 9, Holidays::DateCalculator.day_of_month(year, 9, 3, 1)) }, :function_id => "jp_substitute_holiday(year, 9, Holidays::DateCalculator.day_of_month(year, 9, 3, 1))", :name => "振替休日", :regions => [:jp]},
      ...
      10 => [{:wday => 1, :week => 2, :name => "体育の日", :regions => [:jp]},
            {:function => lambda { |year| Holidays.jp_substitute_holiday(year, 10, Holidays::DateCalculator.day_of_month(year, 10, 2, 1)) }, :function_id => "jp_substitute_holiday(year, 10, Holidays::DateCalculator.day_of_month(year, 10, 2, 1))", :name => "振替休日", :regions => [:jp]}],
