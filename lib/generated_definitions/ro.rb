...
module Holidays
  ...
  module RO # :nodoc:
    ...
    def self.holidays_by_month
      {
                0 => [{:function => "orthodox_easter(year)", :function_arguments => [:year], :function_modifier => -2,  :year_ranges => [{:after => 2018}],:name => "Paștele - Vinerea Mare", :regions => [:ro]},
      ...
      6 => [{:mday => 1,  :year_ranges => [{:after => 2017}],:name => "Ziua Copilului", :regions => [:ro]}],
