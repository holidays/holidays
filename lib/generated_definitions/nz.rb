    ...
    def self.holidays_by_month
      {
            ...
            {:function => "easter(year)", :function_arguments => [:year], :function_modifier => 2, :name => "Southland Anniversary Day", :regions => [:nz_sl]}],
      ...
      10 => [{:wday => 1, :week => 4, :observed => "previous_friday(date)", :observed_arguments => [:date], :name => "Hawke's bay Anniversary Day", :regions => [:nz_hb]},
