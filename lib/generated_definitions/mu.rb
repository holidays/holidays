    ...
    def self.holidays_by_month
      {
            ...
            {:mday => 25,  :year_ranges => [{:limited => [2024]}],:name => "Thaipoosam Cavadee", :regions => [:mu]},
      ...
      2 => [{:mday => 1, :name => "Abolition of Slavery", :regions => [:mu]},
            {:mday => 10,  :year_ranges => [{:limited => [2024]}],:name => "Chinese Spring Festival", :regions => [:mu]},
      ...
      3 => [{:mday => 8,  :year_ranges => [{:limited => [2024]}],:name => "Maha Shivaratree", :regions => [:mu]},
            {:mday => 1,  :year_ranges => [{:limited => [2022]}],:name => "Maha Shivaratree", :regions => [:mu]},
            {:mday => 11,  :year_ranges => [{:limited => [2021]}],:name => "Maha Shivaratree", :regions => [:mu]},
            {:mday => 12, :name => "Independence and Republic Day", :regions => [:mu]}],
      4 => [{:mday => 9,  :year_ranges => [{:limited => [2024]}],:name => "Ugaadi", :regions => [:mu]},
            {:mday => 2,  :year_ranges => [{:limited => [2022]}],:name => "Ougadi", :regions => [:mu]},
      ...
      9 => [{:mday => 8,  :year_ranges => [{:limited => [2024]}],:name => "Ganesh Chaturthi", :regions => [:mu]},
            {:mday => 11,  :year_ranges => [{:limited => [2021]}],:name => "Ganesh Chaturthi", :regions => [:mu]},
            {:mday => 1,  :year_ranges => [{:limited => [2022]}],:name => "Ganesh Chaturthi", :regions => [:mu]}],
      10 => [{:mday => 31,  :year_ranges => [{:limited => [2024]}],:name => "Diwali", :regions => [:mu]},
