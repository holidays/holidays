...
module Holidays
  ...
  module NORTH_AMERICA # :nodoc:
    ...
    def self.holidays_by_month
      {
              0 => [{:function => "easter(year)", :function_modifier => -2, :name => "Good Friday", :regions => [:ca]},
            {:function => "easter(year)", :name => "Easter Sunday", :regions => [:ca]},
            {:function => "easter(year)", :function_modifier => 1, :type => :informal, :name => "Easter Monday", :regions => [:ca]},
            {:function => "easter(year)", :function_modifier => -2, :type => :informal, :name => "Good Friday", :regions => [:us]},
            {:function => "easter(year)", :type => :informal, :name => "Easter Sunday", :regions => [:us]}],
      1 => [{:mday => 1, :name => "New Year's Day", :regions => [:ca]},
            ...
            {:mday => 1, :observed => "to_weekday_if_weekend(date)", :name => "New Year's Day", :regions => [:us]},
            {:wday => 1, :week => 3, :name => "Martin Luther King, Jr. Day", :regions => [:us]},
            {:function => "us_inauguration_day(year)", :name => "Inauguration Day", :regions => [:us_dc]}],
      ...
      5 => [{:function => "ca_victoria_day(year)", :name => "Victoria Day", :regions => [:ca]},
            {:function => "ca_victoria_day(year)", :name => "National Patriotes Day", :regions => [:ca_qc]},
      ...
      7 => [{:mday => 1, :observed => "to_monday_if_sunday(date)", :name => "Canada Day", :regions => [:ca]},
            {:mday => 12, :name => "Orangemen's Day", :regions => [:ca_nf]},
            {:mday => 9, :name => "Nunavut Day", :regions => [:ca_nu]},
            {:mday => 4, :observed => "to_weekday_if_weekend(date)", :name => "Independence Day", :regions => [:us]}],
      ...
      11 => [{:mday => 11, :name => "Remembrance Day", :regions => [:ca]},
            ...
            {:mday => 11, :observed => "to_weekday_if_weekend(date)", :name => "Veterans Day", :regions => [:us]},
            {:wday => 4, :week => 4, :name => "Thanksgiving", :regions => [:us]},
            {:function => "day_after_thanksgiving(year)", :name => "Day after Thanksgiving", :regions => [:us_ca]}],
      12 => [{:mday => 25, :name => "Christmas Day", :regions => [:ca]},
            ...
            {:mday => 25, :observed => "to_weekday_if_weekend(date)", :name => "Christmas Day", :regions => [:us]}],
