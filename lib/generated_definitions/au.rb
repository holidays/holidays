...
module Holidays
  ...
  module AU # :nodoc:
    ...
    def self.holidays_by_month
      ...
      12 => [{:mday => 25, :function => "additional_holiday_if_on_weekend(date)", :function_arguments => [:date], :name => "Additional public holiday for Christmas Day", :regions => [:au_act, :au_nsw, :au_qld, :au_sa, :au_tas, :au_vic, :au_wa, :au_nt]},
