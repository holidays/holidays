...
module Holidays
  ...
  module AU # :nodoc:
    ...
    def self.holidays_by_month
      ...
      4 => [{:mday => 25,  :year_ranges => [{:before => 2025}],:name => "ANZAC Day", :regions => [:au_nsw, :au_sa, :au_tas, :au_vic, :au_act, :au_wa]},
            {:mday => 25,  :year_ranges => [{:before => 2025}],:observed => "to_monday_if_weekend(date)", :observed_arguments => [:date], :name => "ANZAC Day", :regions => [:au_nt, :au_qld]},
            {:mday => 25, :function => "additional_anzac_on_monday_if_on_weekend(date)", :function_arguments => [:date],  :year_ranges => [{:before => 2025}],:name => "Additional public holiday for ANZAC Day", :regions => [:au_sa, :au_act]},
            {:mday => 25,  :year_ranges => [{:after => 2026}],:name => "ANZAC Day", :regions => [:au_nsw, :au_sa, :au_tas, :au_vic, :au_wa, :au_nt]},
            {:mday => 25,  :year_ranges => [{:limited => 2026}],:name => "ANZAC Day", :regions => [:au_act]},
            {:mday => 25, :function => "additional_anzac_on_monday_if_on_weekend(date)", :function_arguments => [:date],  :year_ranges => [{:limited => 2026}],:name => "Additional public holiday for ANZAC Day", :regions => [:au_act]},
      ...
      9 => [{:wday => 1, :week => -1,  :year_ranges => [{:before => 2022}],:name => "Queen's Birthday", :regions => [:au_wa]},
            {:wday => 1, :week => -1,  :year_ranges => [{:after => 2025}],:name => "King's Birthday", :regions => [:au_wa]},
            {:mday => 25,  :year_ranges => [{:limited => 2023}],:name => "King's Birthday", :regions => [:au_wa]},
            {:mday => 23,  :year_ranges => [{:limited => 2024}],:name => "King's Birthday", :regions => [:au_wa]},
