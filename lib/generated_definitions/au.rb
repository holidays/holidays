...
module Holidays
  ...
  module AU # :nodoc:
    ...
    def self.holidays_by_month
      ...
      12 => [{:mday => 25, :name => "Christmas Day", :regions => [:au_act, :au_nsw, :au_qld, :au_sa, :au_tas, :au_vic, :au_wa]},
            ...
            {:mday => 26, :name => "Boxing Day", :regions => [:au_act, :au_nsw, :au_qld, :au_sa, :au_vic, :au_wa]},
