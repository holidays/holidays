...
module Holidays
  ...
  module FEDERAL_RESERVE # :nodoc:
    ...
    def self.holidays_by_month
      {
              1 => [{:mday => 1, :observed => "to_monday_if_sunday(date)", :name => "New Year's Day", :regions => [:federal_reserve]},
      ...
      7 => [{:mday => 4, :observed => "to_monday_if_sunday(date)", :name => "Independence Day", :regions => [:federal_reserve]}],
      9 => [{:wday => 1, :week => 1, :name => "Labor Day", :regions => [:federal_reserve]}],
      10 => [{:wday => 1, :week => 2, :name => "Columbus Day", :regions => [:federal_reserve]}],
      11 => [{:mday => 11, :observed => "to_monday_if_sunday(date)", :name => "Veterans Day", :regions => [:federal_reserve]},
            {:wday => 4, :week => 4, :name => "Thanksgiving Day", :regions => [:federal_reserve]}],
      12 => [{:mday => 25, :observed => "to_monday_if_sunday(date)", :name => "Christmas Day", :regions => [:federal_reserve]}]
      }
    end
